# Home Assistant Add-on: OpenThread Border Router Add-on (Network)

OpenThread Border Router add-on without usb device required. Only for network device.
...
Original Fork Github : https://github.com/Smeagolworms4/core_openthread_border_router
